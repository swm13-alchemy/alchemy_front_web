              ...
              case 'Google':
                return (
                  <button
                    ...
                    onClick={() => signIn(provider.id, {callbackUrl: 'http://localhost:1234/register/step'})}  // TODO: 출시할 때는 링크 변경 (로컬 : http://localhost:1234/register/step / 출시 : https://www.beehealer.com/register/step)
                  >
