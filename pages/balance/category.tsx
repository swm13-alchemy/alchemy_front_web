...
const Category: NextPage = () => {
  ...
  return (
    <ContainerWithBottomNav>
      <BackHeader router={router} name='영양제 구분 카테고리' />
      ...
      <div className='flex flex-col space-y-4 text-gray-900'>
        ...
        <div className='p-6 bg-white'>
          <div className='flex items-start space-x-4'>
            <IntakeAdequateTag state={0} excessOrLackContent={null} unit={null} />
        ...
        <div className='p-6 bg-white'>
          <div className='flex items-start space-x-4'>
            <IntakeAdequateTag state={1} excessOrLackContent={null} unit={null} />
        ...
        <div className='p-6 bg-white'>
          <div className='flex items-start space-x-4'>
            <IntakeAdequateTag state={2} excessOrLackContent={null} unit={null} />
        ...
        <div className='p-6 bg-white'>
          <div className='flex items-start space-x-4'>
            <IntakeAdequateTag state={3} excessOrLackContent={null} unit={null} />
